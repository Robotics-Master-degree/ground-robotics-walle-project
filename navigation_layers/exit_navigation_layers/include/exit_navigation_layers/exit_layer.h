...
#ifndef exit_NAVIGATION_LAYERS_exit_LAYER_H
#define exit_NAVIGATION_LAYERS_exit_LAYER_H
#include <ros/ros.h>
...
{
class exitLayer : public costmap_2d::Layer
{
public:
  exitLayer()
  {
...
#endif  // exit_NAVIGATION_LAYERS_exit_LAYER_H
