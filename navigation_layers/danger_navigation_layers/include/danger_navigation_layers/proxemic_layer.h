...
#ifndef danger_NAVIGATION_LAYERS_PROXEMIC_LAYER_H
#define danger_NAVIGATION_LAYERS_PROXEMIC_LAYER_H
#include <ros/ros.h>
#include <danger_navigation_layers/danger_layer.h>
#include <dynamic_reconfigure/server.h>
#include <danger_navigation_layers/ProxemicLayerConfig.h>
...
{
class ProxemicLayer : public dangerLayer
{
public:
  ProxemicLayer()
  {
...
#endif  // danger_NAVIGATION_LAYERS_PROXEMIC_LAYER_H
