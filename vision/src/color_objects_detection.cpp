...
//        ROS_ERROR("%s",ex.what());
    ...
    //    if (punt_transformat.point.x-persones_points_pose.pose.position.x > abs(0.2) ) {
    //      std::cout <<"PERSONAAA!!! " << persones_points_pose.pose.position << "\n";
    ...
    //    if (punt_transformat.point.x-perill_points_pose.pose.position.x > abs(0.2) ) {
        //  std::cout <<"PERIIIILLL!!! " << perill_points_pose.pose.position << "\n";
  ...
  //      if (punt_transformat.point.x-sortida_points_pose.pose.position.x > abs(0.2) ) {
  //        std::cout <<"SORTIDAAAA!!! " << sortida_points_pose.pose.position << "\n";
...
main (int argc, char** argv)
{
  ...
  Listener listener;
  ros::Subscriber sub = nh.subscribe ("/astra/depth/points", 1, &Listener::callback, &listener);
